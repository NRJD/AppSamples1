...
import org.nrjd.bv.app.samples.net.NetDownloadUtils;
...
public class NetDloadHandler3_Working1 {
    private static final Logger LOG = LoggerFactory.getLogger();
    private HttpClient httpClient = null;
    private File destFile = null;
    private Exception failure = null;

    public NetDloadHandler3_Working1() {
        // HttpClient client = AndroidHttpClient.newInstance("SampleApp");
        this.httpClient = getNewHttpClient(); // HttpClients.createDefault();
    }
